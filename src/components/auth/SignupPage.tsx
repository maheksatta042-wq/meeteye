          ...
          <div className="bg-white/40 backdrop-blur-sm rounded-3xl p-12 border border-white/60">
            ...
            <div className="space-y-6 mt-12">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-slate-900">Comprehensive Analytics</h3>
                  <p className="text-slate-600 mt-1">Get detailed insights into team productivity with visual dashboards and reports</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-slate-900">Team Management</h3>
                  <p className="text-slate-600 mt-1">Manage multiple employees and track their activities from a single dashboard</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="w-full max-w-md mx-auto">
          <div className="bg-white rounded-2xl shadow-2xl p-8 border border-slate-100">
            <div className="text-center mb-8">
              ...
              <p className="text-slate-500 mt-2">Set up your admin account</p>
            </div>
